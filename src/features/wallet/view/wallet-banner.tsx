    ...
    >
      ...
      <View style={styles.content}>
        ...
        <View style={styles.actions}>
          <Action icon={<ArrowDownToLine color={colors.walletDark} size={16} />} label="Guardar" onPress={onSave} />
          <Action icon={<ArrowUpFromLine color={colors.walletDark} size={16} />} label="Resgatar" onPress={onWithdraw} />
        </View>
      </View>
    </ImageBackground>
  );
...
const styles = StyleSheet.create({
  ...
  overlay: { backgroundColor: "#DFF7A4C7", bottom: 0, left: 0, position: "absolute", right: 0, top: 0 },
  ...
  action: { alignItems: "center", backgroundColor: "#FFFFFFB8", borderRadius: 12, flexDirection: "row", gap: 5, paddingHorizontal: 13, paddingVertical: 8 },
