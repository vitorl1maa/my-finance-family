...
const styles = StyleSheet.create({
  ...
  category: { color: colors.text, flex: 1, fontFamily: fonts.semiBold, fontSize: 10 },
  percent: { color: colors.text, fontFamily: fonts.bold, fontSize: 10 },
  value: { color: colors.muted, fontSize: 9, marginTop: 2 },
